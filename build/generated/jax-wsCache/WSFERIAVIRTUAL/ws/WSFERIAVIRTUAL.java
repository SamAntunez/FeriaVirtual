 ...
 * 
 */
@WebServiceClient(name = "WSFERIAVIRTUAL", targetNamespace = "http://WS/", wsdlLocation = "http://localhost:8080/WEBSERVICEFERIAVIRTUAL2/WSFERIAVIRTUAL?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WEBSERVICEFERIAVIRTUAL2/WSFERIAVIRTUAL?WSDL");
